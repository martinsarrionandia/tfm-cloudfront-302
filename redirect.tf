...
resource "aws_s3_bucket_website_configuration" "this" {
  bucket = aws_s3_bucket.this_redirect.id
...
resource "aws_s3_bucket_public_access_block" "this_redirect" {
  bucket = aws_s3_bucket.this_redirect.id
...
resource "aws_cloudfront_distribution" "this" {
  origin {
    ...
    origin_id   = aws_s3_bucket.this_redirect.bucket_regional_domain_name
  ...
  default_cache_behavior {
    ...
    target_origin_id = aws_s3_bucket.this_redirect.bucket_regional_domain_name
